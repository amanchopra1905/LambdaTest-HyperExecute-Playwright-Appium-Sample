...
TestMu AI supports running tests from various regions such as us and eu regions. *region* name specifies in which region you want the device to be allocated
